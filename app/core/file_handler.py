...
class TransactionDocumentHandler:
    ...
    @classmethod
    def validate_document(cls, file_content: bytes, filename: str) -> None:
        """
    ...
    @classmethod
    def save_document(cls, file_content: bytes, filename: str, company_id: int) -> str:
        """
        ...
        """
        cls._ensure_dir()
        cls.validate_document(file_content, filename)
